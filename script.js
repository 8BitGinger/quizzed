...
var questions = [
  ...
  {
    question:
      'Which JavaScript label catches all the values, excep for the ones specified?',
    answers: [
  ...
  {
    question:
      "Which are the correct 'if' statemetns to execute certain code if 'x' is equal to 2?",
    answers: [
...
function newField() {
  ...
  input.type = 'input';
  input.id = 'input';
  input.placholder = 'Enter Initials Here';
